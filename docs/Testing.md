...
The plugin has a focused unit-test suite (**84 tests as of 2026-08-17**) over the **pure logic that can run outside the
...
|---|---|---|
| **HumankindAssetFramework** (plugin) | `dotnet build` · `dotnet test` (84) · registry schema parity | seconds |
