...
> **📁 ARCHIVED NOTE — frozen 2026-08-01, not maintained.** A point-in-time audit, kept for its reasoning and its
> findings-class taxonomy. Every finding here was triaged into [Review-Backlog.md](../Review-Backlog.md) or
> [Framework-Review.md](../Framework-Review.md) — read those for current status. Nothing below is current instructions.
...
## 2. FIXED (see below, NOT yet verified in game) · MEDIUM-HIGH — a rules-only pack permanently disabled the mesh-scale engine
