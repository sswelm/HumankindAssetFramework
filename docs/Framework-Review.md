...
| **Medium** | `117 vs 499/526` | static path `CreateAsset` without `DeleteAsset` while animated path deletes first → **opposite** behavior. Decide: overwrite (GUID-stable) is arguably preferable; make both consistent. |
