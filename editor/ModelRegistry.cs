...
public class ModelDef : Haf.Schema.HafModelSchema
{
    ...
    public bool multiMesh = false;      // OPT-IN (2026-09-13, the Bremen): a static bake over the 16,320-quad per-fragment ceiling splits into _ModelMesh_B.. chunks the plugin draws as extra fragments. Off = the classic warn-and-clip behavior — a conscious choice, more fragments cost more draw work
